...
namespace Interview.Infrastructure.Migrations
{
    ...
    [Migration("20240616043916_add-interview-dbset")]
    partial class addinterviewdbset
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Interview.Domain.Aggregates.Companies.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Interview.Domain.Aggregates.Interviews.InterviewProcess", b =>
                {
                    ...
                    b.Property<Guid>("InterviewCollectionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Interview.Domain.Aggregates.Companies.Address", b =>
                {
                    b.HasOne("Interview.Domain.Aggregates.Companies.Company", "Company")
            ...
            modelBuilder.Entity("Interview.Domain.Aggregates.Companies.Job", b =>
                {
                    ...
                    b.HasOne("Interview.Domain.Aggregates.Companies.JobCategory", "JobCategory")
                        .WithMany("Jobs")
            ...
            modelBuilder.Entity("Interview.Domain.Aggregates.Interviews.InterviewProcess", b =>
                {
                    b.HasOne("Interview.Domain.Aggregates.Interviews.InterviewCollection", "InterviewCollection")
                        .WithMany("Process")
                        .HasForeignKey("InterviewCollectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("InterviewCollection");
                });
